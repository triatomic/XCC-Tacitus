...
namespace keybinds
{
	namespace
	{
		...
		const Binding g_defaults[] =
		{
			...
			{ "file_reload_mix_db",       "Reload mix database",     scope_accel, ID_FILE_RELOAD_MIX_DB,        'R',         FCONTROL | FSHIFT,  mb_none, 0 },
			...
			{ "popup_explore",            "Explore",                 scope_accel, ID_POPUP_EXPLORE,             'E',         FCONTROL,           mb_none, 0 },
